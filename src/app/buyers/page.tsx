  ...
  return (
    <div className="h-full overflow-y-auto bg-[#f6f5f1]">
      <div className="max-w-[1100px] mx-auto px-6 py-8 flex flex-col gap-5">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[12.5px] text-[#9b978f] mt-0.5">
              Your buyer network and their buy boxes.
            </p>
          </div>
          <button
        ...
        {/* Two-column: buyer list + AI match panel */}
        <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-4 items-start">
          <div className="bg-white border border-[#e6e3dc] rounded-[12px] py-20 flex flex-col items-center gap-3">
            <div className="w-12 h-12 rounded-[14px] bg-[#2f5d5014] flex items-center justify-center">
              <Handshake size={22} className="text-[#2f5d50]" />
            </div>
            <p className="text-[14px] font-semibold text-[#23211d]">No buyers yet</p>
            <p className="text-[12.5px] text-[#9b978f]">Add your first buyer.</p>
          </div>

          <div className="bg-white border border-[#e6e3dc] rounded-[12px] overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-3 bg-[#faf8f3] border-b border-[#e6e3dc]">
              <Sparkles size={13} className="text-[#2f5d50]" />
              <span className="text-[12px] font-semibold text-[#23211d]">
                AI Deal Matching
              </span>
            </div>
            <p className="text-[12.5px] text-[#9b978f] px-4 py-12 text-center">
              Add buyers with buy boxes to see matches.
            </p>
          </div>
        </div>
      </div>

      {/* Stubbed add-buyer modal */}
      {showAddModal && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-[16px] w-full max-w-[440px] shadow-[0_24px_60px_rgba(40,35,25,0.22)] overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#e6e3dc]">
              <span className="text-[15px] font-semibold">Add buyer</span>
              <button
